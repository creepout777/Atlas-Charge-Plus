...
export const ordersService = {
  ...
  async createOrder(orderData, userId) {
    const record = {
      ...
      charge_package_id: orderData.charge_package_id,
      connector_type_id: orderData.connector_type_id,
      vehicle_id: orderData.vehicle_id,
      tariff_id: orderData.tariff_id || 'e0000001-0000-0000-0000-000000000001',
